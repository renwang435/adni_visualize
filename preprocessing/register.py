...
# parent_dir = os.path.join(home, 'Documents/adni_visualize')
...
fsldir = str(os.path.expandvars("$FSLDIR"))
ref_path = os.path.join(fsldir, 'data', 'standard', 'MNI152_T1_1mm.nii.gz')
